...
i.e., a headlines  can contain subheadlines (and paragraphs  and unordered lists
...
Furthermore, the maximum number of items on given hierarchy level is 54, i.e., 9
tiles on each of the 6 sides of a cube.
