...
The will run a tween animation to the selected target from the current location.
The Space key will zoom forward and backwards from the current position.
